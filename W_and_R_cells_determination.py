...
## Vg image
vg_image = plt.imread("/path/Vg_image.png") # Write the path to the file instead of "path"
...
xy_min = pd.read_csv("/path/xy_coor_vgmin.csv") # Write the path to the file instead of "path"
